    ...
    return(
        <div className="project" ref={ref}>
            ...
            <div className="projectWrap">
                    ...
                    협력사(웨이브) 소속으로 작업한 프로젝트로, 기획서를 기반으로 디자인된 내용을 퍼블리싱하며 매거진에 적합한 레이아웃을 구성해 기획 의도에 맞는 매거진 페이지를 구현했습니다.
                    </div>
                </div>
            <div className="item shadow">
                    <h4 className='itemTit'>
                    ...
                    <div className="article">
                    협력사(웨이브) 소속으로 작업한 작업물로, 기획서를 기반으로 디자인된 내용을 퍼블리싱하였습니다. slick, scrolla와 같은 다양한 라이브러리를 활용해 요청된 애니메이션 효과(슬라이더, 스크롤 인터랙션 등)를 기획서의 요구 사항에 맞춰 구현하였습니다.  
                    </div>
                </div>
            <div className="item shadow">
                    <h4 className='itemTit'>
