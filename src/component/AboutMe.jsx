      ...
      <div className="wrap">
        <div className="item">
          ...
          <div className="content">
            ...
            <p className="text">원민영</p>
          </div>
        </div>
        <a href="https://github.com/Fantasystar94" target="_blank" className="item clickable">
          <div className="imgs">
          ...
          <div className="content">
            ...
            <p className="text" >Fantasystar94</p>
          </div>
        </a>
        <div className="item">
            <div className="imgs">
            ...
            <p className="text">010-3124-3785</p>
            </div>
        </div>
        <div className="item">
            <div className="imgs">
            ...
            <div className="content">
                ...
                <p className="text">서울시 노원구 공릉동</p>
            </div>
        </div>
        <div className="item">
            <div className="imgs">
            ...
            <div className="content">
                <h5 className="title">Birth</h5>
                <p className="text">1994.12.29</p>
            </div>
        </div>
        <div className="item">
            <div className="imgs">
            ...
            <div className="content">
                ...
                <p className="text">aniseed_3@naver.com</p>
            </div>
        </div>
      </div>
    </div>
